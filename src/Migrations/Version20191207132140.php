 ...
 */
final class Version20191207132140 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ad (id INT AUTO_INCREMENT NOT NULL, boost_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, price NUMERIC(10, 2) NOT NULL, created_at DATETIME NOT NULL, description LONGTEXT NOT NULL, type VARCHAR(255) NOT NULL, view_count INT NOT NULL, hidden TINYINT(1) NOT NULL, report_count INT NOT NULL, UNIQUE INDEX UNIQ_77E0ED58B09F48DA (boost_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
